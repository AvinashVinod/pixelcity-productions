      ...
      <section className="min-h-dvh bg-white text-black flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-500">
            No testimonials found. Please add testimonials in Sanity Studio.
          </p>
        </div>
      </section>
    );
    ...
    <section ref={testimonialsRef} className="min-h-dvh bg-white text-black">
      <div className="flex flex-col gap-10 max-width mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between">
          <h1 className="basis-[80%] mb-15 md:mb-6 leading-none text-center md:text-left">
            Trusted by Happy Couples
          </h1>
          <div className="relative basis-[20%] grow aspect-square h-70 w-70 md:h-60 md:w-60 grid grid-cols-1 grid-rows-1">
            {/* Main image */}
            <div className="relative h-full w-full z-1 rotate-12 rounded-lg overflow-hidden col-start-1 col-end-2 row-start-1 row-end-2">
              <img
                ref={coupleImageRef}
            ...
            {/* Paperclip using grid placement */}
            <div className="z-10 h-25 rotate-12 justify-self-end self-start -mt-4 -mr-2 col-start-1 col-end-2 row-start-1 row-end-2">
              <svg
                width="100%"
                height="100%"
                viewBox="0 0 169 504"
              ...
              >
                <path
                  d="M7 200.509C7 200.509 7 102.974 7 72.3002C7 41.6266 49.3717 7 85 7C130.808 6.99968 160.084 42.6606 161.259 72.3002C162.433 101.94 162.042 408.676 161.259 440.383C160.476 472.091 124.364 496.5 95 496.5C61.3293 496.5 26.576 468.989 26.576 440.383C26.576 411.777 26.576 128.646 26.576 128.646"
                  stroke="#B79728"
                  stroke-width="14"
        ...
        <div className="md:flex gap-10">
          <div className="md:basis-[20%] flex flex-col items-end">
            ...
            <div className="h-40 w-40 hidden md:block">
              ...
              >
                <path
                  d="M3.50443 0.273438C-9.49742 118.273 106.004 259.773 218.004 162.773C280.737 108.443 271.004 83.0129 258.504 71.7734C199.004 18.2734 188.665 162.773 199.004 231.273C209.344 299.773 222.649 373.332 293.004 404.773C375.897 441.818 509.004 318.773 509.004 318.773M486.504 318.773H509.004L504.504 342.273"
                  stroke="black"
                  stroke-width="5"
                />
              </svg>
          ...
          <div className="flex flex-col justify-between md:basis-[80%] ">
            ...
            <div className="text-center md:text-left">
              <h3 className="h2 text-[1.8rem] lg:text-[3rem] leading-tight text-box-trim mb-5">
                {currentTestimonial.coupleName}
              </h3>
