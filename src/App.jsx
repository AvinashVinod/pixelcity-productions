...
const FALLBACK_COLLECTION = [
    { heading: 'Pre-wedding Photography', imageUrl: 'https://images.unsplash.com/photo-1749522025490-aee529bbf594?q=80&w=2070&auto=format&fit=crop', alt: 'Pre-wedding', order: 1 },
    { heading: 'Wedding films',            imageUrl: 'https://images.unsplash.com/photo-1744804298523-9e4ddf5e6dc4?q=80&w=2070&auto=format&fit=crop', alt: 'Wedding films', order: 2 },
    { heading: 'Pre-wedding films',        imageUrl: 'https://images.unsplash.com/photo-1727430334140-c21dc3d415f1?q=80&w=2070&auto=format&fit=crop', alt: 'Pre-wedding films', order: 3 },
    { heading: 'Wedding photography',      imageUrl: 'https://images.unsplash.com/photo-1727430334033-d2ffe559bdce?q=80&w=1974&auto=format&fit=crop', alt: 'Wedding photography', order: 4 },
];
...
.catch((err) => console.error('Homepage fetch error:', err));
            // ↑ no setLoading — components render with fallbacks immediately
    }, [pathname]);
    ...
    return (
        <div className="h-full w-full min-h-dvh bg-[#E3E2DD] overflow-hidden">
            <Navbar introKey={pathname === '/' ? key : 'static'} isHomeRoute={pathname === '/'} />
            <Routes>
                <Route
                    path="/"
                    element={
                        <React.Fragment key={key}>
                            ...
                            <div className="relative z-20">
                                ...
                                {/*
                                  ✅ Always pass real items — fallback if Sanity data not yet arrived.
                                  Collection never renders a loading placeholder that breaks layout height.
                                */}
                                <Collection
